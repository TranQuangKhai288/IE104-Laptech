...
const Profile: React.FC = () => {
    const [accountInfo, setAccountInfo] = useState({
        name: 'Xuan Quynh Le',
        phoneNumber: '',
        email: 'xuanquynhle@gmail.com',
        addressLine: '',
        ward: 'Xã An Phú',
        district: 'Quận 1',
        city: 'Hồ Chí Minh',
        avatarLink: '/default-avatar.png', 
    });
            ...
            <div className="flex space-x-4">
                ...
                <div className="flex-1 bg-gray-100 p-4 rounded-lg shadow">
                    <div className="flex justify-center items-center h-full mb-4 relative">
                        ...
                        >
                            <img
                                src={avatar ? URL.createObjectURL(avatar) : accountInfo.avatarLink}
                                alt="Avatar"
                            ...
                            <span className="absolute bottom-12 left-1/2 transform -translate-x-1/2 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8 text-gray-500">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 7.5h15l-1.5 9H6l-1.5-9zm3.75 10.5a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
                                </svg>
                            </span>
